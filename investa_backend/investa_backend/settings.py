"""
Django settings for investa_backend project.
...
ROOT_URLCONF = 'investa_backend.urls'
...
WSGI_APPLICATION = 'investa_backend.wsgi.application'
...
# Append trailing slash for API consistency
APPEND_SLASH = True
...
REST_FRAMEWORK = {
    ...
    'EXCEPTION_HANDLER': 'investa_backend.exceptions.custom_exception_handler',
}
